                ...
                >
                      ...
                      children={(field) => (
                        <div>
                          <input
                            ...
                            className={`w-full px-4 py-2 rounded-lg bg-primary-foreground/5 border backdrop-blur-sm text-primary-foreground placeholder-primary-foreground/40 focus:outline-none focus:ring-2 focus:ring-primary transition-all ${
                    ...
                    <form.Field
                      ...
                      children={(field) => (
                        <textarea
                          ...
                          rows={5}
                          className="w-full px-4 py-2 rounded-lg bg-primary-foreground/5 border border-primary-foreground/20 backdrop-blur-sm text-primary-foreground placeholder-primary-foreground/40 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary-foreground/40 transition-all resize-none"
                        />
                      )}
                    />
                  </div>
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <Button
                      ...
                      className="flex-1 border border-primary-foreground/40 text-primary-foreground hover:bg-primary-foreground/10 font-semibold py-2 rounded-lg transition-all"
                    >
                      Limpiar
                    </Button>
                  </div>
